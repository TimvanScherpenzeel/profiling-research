...
run() {
    ...
    /Applications/Google\ Chrome\ Canary.app/Contents/MacOS/Google\ Chrome\ Canary $LOCATION --incognito --allow-file-access-from-files --js-flags="--trace-file-names --trace-opt --trace-deopt --print-opt-source --code-comments --disable-gpu-vsync" 1> $LOG_OUTPUT 2> $LOG_ERROR
}
